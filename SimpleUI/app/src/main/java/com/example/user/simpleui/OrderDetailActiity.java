...
class OrderDetailActivity extends AppCompatActivity implements GeocodingTaskResponse,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                text += object.getString("name") + " : 大杯" + object.getString("l") + "杯   中杯" + object.getString("l") + "杯" + "\n";
            }
...
//            (new GeoCodingTask(photo)).execute("台北市羅斯福路四段一號");
    ...
    @Override
    public void reponseWithGeocdingResults(LatLng location) {
    ...
    private static class GeoCodingTask extends AsyncTask<String, Void, double[]>
    {
        ...
        protected void onPostExecute(double[] latlng) {
            if (latlng != null && geocodingTaskResponseWeakReference.get() != null)
            {
                ...
                response.reponseWithGeocdingResults(storeLocation);
            }
        }
...
{
    void reponseWithGeocdingResults(LatLng location);
}